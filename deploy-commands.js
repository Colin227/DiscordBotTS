...
const commands = [
    ...
    new SlashCommandBuilder().setName('summarize').setDescription("Summarize the last N messages in this channel")
        .addIntegerOption((opt) =>
            opt
                .setName('count')
                .setDescription('How many recent messages to include (default 50, max 100)')
                .setMinValue(10)
                .setMaxValue(100)
                .setRequired(false)
        )
